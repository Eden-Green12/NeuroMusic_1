...
var messagesRef = firebase.database().ref('Data').child(id).child("Block2");
...
function showQuetions(index) {
  ...
  let que_tag = '<span>' + num[index] + '. ' + 'You receive ' + '<span>' + num2[Math.floor(Math.random() * num2.length)] + '</span>' + ' shocks' + '<br>' + ' and you receive ' + '<span>' + num1[Math.floor(Math.random() * num1.length)] + '</span> Rs' +
...
function optionSelected(answer) {
  ...
  // console.log(question + "  " + userAns + " " + time_value);
...
function playMusic() {
  ...
  console.log("parsedarry 2: "+parsedArr);
  element = parsedArr[1];
