...
var messagesRef = firebase.database().ref('Data').child(id).child("Block3");
...
function showQuetions(index) {
  ...
  let que_tag = '<span>' + num[index] + '. ' + 'Your partner recieves ' + '<span>' + num2[Math.floor(Math.random() * num2.length)] + '</span>' + ' shocks' + '<br>' + ' and you get ' + '<span>' + num1[Math.floor(Math.random() * num1.length)] + '</span> Rs' +
...
function playMusic() {
  ...
  console.log("parsedarry 3: "+parsedArr);
  element = parsedArr[2];
