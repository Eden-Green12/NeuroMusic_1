...
var messagesRef = firebase.database().ref('Data').child(id).child("Block4");
...
function showQuetions(index) {
  ...
  let que_tag = '<span>' + num[index] + '. ' + 'Your partner recieves ' + '<span>' + num2[Math.floor(Math.random() * num2.length)] + '</span>' + ' shocks' + '<br>' + ' and they recieve ' + '<span>' + num1[Math.floor(Math.random() * num1.length)] + '</span> Rs' +
...
function playMusic() {
  ...
  console.log("parsedarry 4: "+parsedArr);
  element = parsedArr[3];
